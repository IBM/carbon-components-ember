const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CWFFxXSG.js","assets/index-DUpYiFjb.js","assets/index-D2CeE0KS.js","assets/index-D0QfW_WZ.js","assets/index-wpd4cMTr.js","assets/index-DxA39neW.js","assets/index-BwNgSor_.js","assets/index-e9GdCNnW.js","assets/index-DCvuG16M.js","assets/index-B0GZd3r0.js","assets/index-gcA9wcjs.js","assets/index-BvYic9qT.js","assets/index-ps4p4VqT.js","assets/index-DiPIt7MU.js","assets/index-D-_4wYq9.js","assets/index-DU2EOhSG.js","assets/index-DylhAgeI.js","assets/index-IyNvpBxl.js","assets/index-DuqlR7T0.js","assets/index-DwsWx3R5.js","assets/dockerfile-BuGto-eh.js","assets/simple-mode-DTO65gHN.js","assets/factor-P_9RAvyH.js","assets/nsis-DIgWeoaq.js","assets/pug-DdQ9vxDY.js","assets/javascript-Bt78-ZxY.js","assets/index-C_DIWei8.js","assets/index-ZOUaGep_.js","assets/index-iMYSLQnz.js","assets/index-Bltl8Ete.js","assets/index-CQ4uCkiZ.js","assets/index-C8NLE66s.js"])))=>i.map(i=>d[i]);
import { R as __vitePreload } from './main-vBcrfInl.js';
import { m as markdown, p as parser, G as GFM, S as Subscript, a as Superscript, E as Emoji, T as Table } from './index-ps4p4VqT.js';
import { c as LanguageDescription, L as LanguageSupport, S as StreamLanguage, x as Language, y as defineLanguageFacet, d as foldNodeProp, i as indentNodeProp, A as languageDataProp } from './index-DUpYiFjb.js';
import './index-D0QfW_WZ.js';
import './index-DxA39neW.js';
...
function sql(dialectName) {
  return __vitePreload(() => import('./index-CWFFxXSG.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0).then(m => m.sql({
...
LanguageDescription.of({
  ...
  extensions: ["c", "h", "ino"],
  load() {
    return __vitePreload(() => import('./index-wpd4cMTr.js'),true              ?__vite__mapDeps([4,1,2]):void 0).then(m => m.cpp());
  }
  ...
  extensions: ["css"],
  load() {
    return __vitePreload(() => import('./index-DxA39neW.js').then(n => n.i),true              ?__vite__mapDeps([5,1,2,3]):void 0).then(m => m.css());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Go",
  extensions: ["go"],
  load() {
    return __vitePreload(() => import('./index-BwNgSor_.js'),true              ?__vite__mapDeps([6,1,2,3]):void 0).then(m => m.go());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "HTML",
  alias: ["xhtml"],
  ...
  load() {
    return __vitePreload(() => import('./index-DxA39neW.js').then(n => n.e),true              ?__vite__mapDeps([5,1,2,3]):void 0).then(m => m.html());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Java",
  extensions: ["java"],
  load() {
    return __vitePreload(() => import('./index-e9GdCNnW.js'),true              ?__vite__mapDeps([7,1,2]):void 0).then(m => m.java());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JavaScript",
  ...
  load() {
    return __vitePreload(() => import('./index-D0QfW_WZ.js').then(n => n.k),true              ?__vite__mapDeps([3,1,2]):void 0).then(m => m.javascript());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Jinja",
  extensions: ["j2", "jinja", "jinja2"],
  load() {
    return __vitePreload(() => import('./index-DCvuG16M.js'),true              ?__vite__mapDeps([8,1,2,5,3]):void 0).then(m => m.jinja());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JSON",
  alias: ["json5"],
  extensions: ["json", "map"],
  load() {
    return __vitePreload(() => import('./index-B0GZd3r0.js'),true              ?__vite__mapDeps([9,1,2]):void 0).then(m => m.json());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JSX",
  extensions: ["jsx"],
  ...
  extensions: ["less"],
  load() {
    return __vitePreload(() => import('./index-gcA9wcjs.js'),true              ?__vite__mapDeps([10,1,2,5,3]):void 0).then(m => m.less());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Liquid",
  extensions: ["liquid"],
  load() {
    return __vitePreload(() => import('./index-BvYic9qT.js'),true              ?__vite__mapDeps([11,1,2,5,3]):void 0).then(m => m.liquid());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "MariaDB SQL",
  load() {
  ...
  load() {
    return __vitePreload(() => import('./index-ps4p4VqT.js').then(n => n.i),true              ?__vite__mapDeps([12,1,2,3,5]):void 0).then(m => m.markdown());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "MS SQL",
  load() {
  ...
  load() {
    return __vitePreload(() => import('./index-DiPIt7MU.js'),true              ?__vite__mapDeps([13,1,2,5,3]):void 0).then(m => m.php());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "PLSQL",
  extensions: ["pls"],
  ...
  filename: /^(BUCK|BUILD)$/,
  load() {
    return __vitePreload(() => import('./index-D-_4wYq9.js'),true              ?__vite__mapDeps([14,1,2,3]):void 0).then(m => m.python());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Rust",
  extensions: ["rs"],
  load() {
    return __vitePreload(() => import('./index-DU2EOhSG.js'),true              ?__vite__mapDeps([15,1,2]):void 0).then(m => m.rust());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Sass",
  extensions: ["sass"],
  load() {
    return __vitePreload(() => import('./index-DylhAgeI.js'),true              ?__vite__mapDeps([16,1,2,5,3]):void 0).then(m => m.sass({
      indented: true
    }));
  }
}), /*@__PURE__*/LanguageDescription.of({
  ...
  extensions: ["wat", "wast"],
  load() {
    return __vitePreload(() => import('./index-IyNvpBxl.js'),true              ?__vite__mapDeps([17,1,2]):void 0).then(m => m.wast());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "XML",
  alias: ["rss", "wsdl", "xsd"],
  ...
  load() {
    return __vitePreload(() => import('./index-DuqlR7T0.js'),true              ?__vite__mapDeps([18,1,2]):void 0).then(m => m.xml());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "YAML",
  alias: ["yml"],
  extensions: ["yaml", "yml"],
  load() {
    return __vitePreload(() => import('./index-DwsWx3R5.js'),true              ?__vite__mapDeps([19,1,2]):void 0).then(m => m.yaml());
  }
}),
...
LanguageDescription.of({
  ...
  filename: /^Dockerfile$/,
  load() {
    return __vitePreload(() => import('./dockerfile-BuGto-eh.js'),true              ?__vite__mapDeps([20,21]):void 0).then(m => legacy(m.dockerFile));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "DTD",
  extensions: ["dtd"],
  ...
  extensions: ["factor"],
  load() {
    return __vitePreload(() => import('./factor-P_9RAvyH.js'),true              ?__vite__mapDeps([22,21]):void 0).then(m => legacy(m.factor));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "FCL",
  load() {
  ...
  extensions: ["nsh", "nsi"],
  load() {
    return __vitePreload(() => import('./nsis-DIgWeoaq.js'),true              ?__vite__mapDeps([23,21]):void 0).then(m => legacy(m.nsis));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "NTriples",
  extensions: ["nt", "nq"],
  ...
  extensions: ["pug", "jade"],
  load() {
    return __vitePreload(() => import('./pug-DdQ9vxDY.js'),true              ?__vite__mapDeps([24,25]):void 0).then(m => legacy(m.pug));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Puppet",
  extensions: ["pp"],
  ...
  extensions: ["vue"],
  load() {
    return __vitePreload(() => import('./index-C_DIWei8.js'),true              ?__vite__mapDeps([26,1,2,5,3]):void 0).then(m => m.vue());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Angular Template",
  load() {
    return __vitePreload(() => import('./index-ZOUaGep_.js'),true              ?__vite__mapDeps([27,1,2,5,3]):void 0).then(m => m.angular());
  }
})];
...
const codeLanguages = [...languages, LanguageDescription.of({
  ...
  async load() {
    ...
    const {
      ...
      glimmer
    } = await import('./index-iMYSLQnz.js');return {
      glimmer
    }},true              ?__vite__mapDeps([28,1,2,5,3]):void 0);
    return glimmer();
  }
}), LanguageDescription.of({
  name: 'glimmer-js',
  ...
  async load() {
    ...
    const {
      ...
      gjs
    } = await import('./index-Bltl8Ete.js');return {
      gjs
    }},true              ?__vite__mapDeps([29,3,1,2,28,5]):void 0);
    return gjs();
  }
}), LanguageDescription.of({
  name: 'glimmer-ts',
  ...
  async load() {
    ...
    const {
      ...
      vue
    } = await import('./index-C_DIWei8.js');return {
      vue
    }},true              ?__vite__mapDeps([26,1,2,5,3]):void 0);
    return vue();
  }
}), LanguageDescription.of({
  name: 'svelte',
  ...
  async load() {
    ...
    const {
      ...
      svelte
    } = await import('./index-CQ4uCkiZ.js');return {
      svelte
    }},true              ?__vite__mapDeps([30,1,2,5,3]):void 0);
    return svelte();
  }
}), LanguageDescription.of({
  name: 'javascript',
  ...
  async load() {
    ...
    const {
      ...
      javascript
    } = await import('./index-D0QfW_WZ.js').then(n => n.k);return {
      javascript
  ...
  async load() {
    ...
    const {
      ...
      mermaid
    } = await import('./index-C8NLE66s.js');return {
      mermaid
    }},true              ?__vite__mapDeps([31,1,2]):void 0);
    return mermaid();
  }
}), LanguageDescription.of({
  name: 'yaml',
  ...
  async load() {
    ...
    const {
      ...
      yaml
    } = await import('./index-DwsWx3R5.js');return {
      yaml
    }},true              ?__vite__mapDeps([19,1,2]):void 0);
    return yaml();
  }
})];
function glimdown() {
