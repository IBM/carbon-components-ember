const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-BdJyR6O4.js","assets/main-D8Q_DBA2.js","assets/main-CFbrRHer.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-D8Q_DBA2.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-BdJyR6O4.js');return {
    parseMarkdown
