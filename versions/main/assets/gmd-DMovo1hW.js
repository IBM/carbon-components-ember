const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-ueGLKJ5r.js","assets/main-DFVRdCgW.js","assets/main-DZzPJjph.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-DFVRdCgW.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-ueGLKJ5r.js');return {
    parseMarkdown
