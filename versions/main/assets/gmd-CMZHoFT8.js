const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-BON8-oJo.js","assets/main-CQUnnPV7.js","assets/main-DKHu0Zdr.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CQUnnPV7.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-BON8-oJo.js');return {
    parseMarkdown
