...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-D2wBNdgW.js'),true              ?[]:void 0), __vitePreload(() => import('./plugin-DK6AlHvS.js').then(n => n.p),true              ?__vite__mapDeps([0,1]):void 0)]);
