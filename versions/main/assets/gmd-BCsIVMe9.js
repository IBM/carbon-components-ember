const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-cUSJRg5_.js","assets/main-DbFdYi34.js","assets/main-CFbrRHer.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-DbFdYi34.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-cUSJRg5_.js');return {
    parseMarkdown
