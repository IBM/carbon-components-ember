const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Dicnx6Eo.js","assets/main-C0BQH3pw.js","assets/main-BRDg_8S7.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-C0BQH3pw.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Dicnx6Eo.js');return {
    parseMarkdown
