const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DCtcv063.js","assets/index-BZr71EI0.js","assets/index-D2CeE0KS.js","assets/index-DjmRBv4T.js","assets/index-DoDyyjRT.js","assets/index-Cnt_vpi1.js","assets/index-Da_U3wY2.js","assets/index-CBOBduv1.js","assets/index-CkCz5A90.js","assets/index-dqVyFyRL.js","assets/index-Dgeau-Mn.js","assets/index-BiuIFVSl.js","assets/index-C-BWbCAj.js","assets/index--FXhCwWr.js","assets/index-DmyIQafo.js","assets/index-AIiFV6Iq.js","assets/index-DnoQzHbi.js","assets/index-ASyWVRhN.js","assets/index-gZrKfYDy.js","assets/index-DDGMdSkU.js","assets/index-C0R4c4x6.js","assets/index-BPKb9E5L.js","assets/index-Yg46vtod.js","assets/dockerfile-BuGto-eh.js","assets/simple-mode-DTO65gHN.js","assets/factor-P_9RAvyH.js","assets/nsis-DIgWeoaq.js","assets/pug-DdQ9vxDY.js","assets/javascript-Bt78-ZxY.js","assets/index-BO4Xrq47.js","assets/index-BveSpPBk.js"])))=>i.map(i=>d[i]);
import { R as __vitePreload } from './main-CQUnnPV7.js';
import { L as LanguageDescription, a as LanguageSupport, S as StreamLanguage } from './index-BZr71EI0.js';

function legacy(parser) {
  return new LanguageSupport(StreamLanguage.define(parser));
}
function sql(dialectName) {
  return __vitePreload(() => import('./index-DCtcv063.js'),true              ?__vite__mapDeps([0,1,2,3,4]):void 0).then(m => m.sql({
...
LanguageDescription.of({
  ...
  extensions: ["c", "h", "ino"],
  load() {
    return __vitePreload(() => import('./index-Cnt_vpi1.js'),true              ?__vite__mapDeps([5,3,1,2]):void 0).then(m => m.cpp());
  }
  ...
  extensions: ["css"],
  load() {
    return __vitePreload(() => import('./index-Da_U3wY2.js'),true              ?__vite__mapDeps([6,3,1,2]):void 0).then(m => m.css());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Go",
  extensions: ["go"],
  load() {
    return __vitePreload(() => import('./index-CBOBduv1.js'),true              ?__vite__mapDeps([7,3,1,2,4]):void 0).then(m => m.go());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "HTML",
  alias: ["xhtml"],
  ...
  load() {
    return __vitePreload(() => import('./index-CkCz5A90.js'),true              ?__vite__mapDeps([8,3,1,2,6,9,4]):void 0).then(m => m.html());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Java",
  extensions: ["java"],
  load() {
    return __vitePreload(() => import('./index-Dgeau-Mn.js'),true              ?__vite__mapDeps([10,3,1,2]):void 0).then(m => m.java());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JavaScript",
  ...
  load() {
    return __vitePreload(() => import('./index-dqVyFyRL.js').then(n => n.i),true              ?__vite__mapDeps([9,3,1,2,4]):void 0).then(m => m.javascript());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Jinja",
  extensions: ["j2", "jinja", "jinja2"],
  load() {
    return __vitePreload(() => import('./index-BiuIFVSl.js'),true              ?__vite__mapDeps([11,1,2,8,3,6,9,4]):void 0).then(m => m.jinja());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JSON",
  alias: ["json5"],
  extensions: ["json", "map"],
  load() {
    return __vitePreload(() => import('./index-C-BWbCAj.js'),true              ?__vite__mapDeps([12,3,1,2]):void 0).then(m => m.json());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "JSX",
  extensions: ["jsx"],
  ...
  extensions: ["less"],
  load() {
    return __vitePreload(() => import('./index--FXhCwWr.js'),true              ?__vite__mapDeps([13,1,2,6,3]):void 0).then(m => m.less());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Liquid",
  extensions: ["liquid"],
  load() {
    return __vitePreload(() => import('./index-DmyIQafo.js'),true              ?__vite__mapDeps([14,1,2,8,3,6,9,4]):void 0).then(m => m.liquid());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "MariaDB SQL",
  load() {
  ...
  load() {
    return __vitePreload(() => import('./index-AIiFV6Iq.js').then(n => n.i),true              ?__vite__mapDeps([15,1,2,4,8,3,6,9]):void 0).then(m => m.markdown());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "MS SQL",
  load() {
  ...
  load() {
    return __vitePreload(() => import('./index-DnoQzHbi.js'),true              ?__vite__mapDeps([16,3,1,2,8,6,9,4]):void 0).then(m => m.php());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "PLSQL",
  extensions: ["pls"],
  ...
  filename: /^(BUCK|BUILD)$/,
  load() {
    return __vitePreload(() => import('./index-ASyWVRhN.js'),true              ?__vite__mapDeps([17,3,1,2,4]):void 0).then(m => m.python());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Rust",
  extensions: ["rs"],
  load() {
    return __vitePreload(() => import('./index-gZrKfYDy.js'),true              ?__vite__mapDeps([18,3,1,2]):void 0).then(m => m.rust());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Sass",
  extensions: ["sass"],
  load() {
    return __vitePreload(() => import('./index-DDGMdSkU.js'),true              ?__vite__mapDeps([19,3,1,2,6]):void 0).then(m => m.sass({
      indented: true
    }));
  }
}), /*@__PURE__*/LanguageDescription.of({
  ...
  extensions: ["wat", "wast"],
  load() {
    return __vitePreload(() => import('./index-C0R4c4x6.js'),true              ?__vite__mapDeps([20,1,2,3]):void 0).then(m => m.wast());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "XML",
  alias: ["rss", "wsdl", "xsd"],
  ...
  load() {
    return __vitePreload(() => import('./index-BPKb9E5L.js'),true              ?__vite__mapDeps([21,3,1,2]):void 0).then(m => m.xml());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "YAML",
  alias: ["yml"],
  extensions: ["yaml", "yml"],
  load() {
    return __vitePreload(() => import('./index-Yg46vtod.js'),true              ?__vite__mapDeps([22,3,1,2]):void 0).then(m => m.yaml());
  }
}),
...
LanguageDescription.of({
  ...
  filename: /^Dockerfile$/,
  load() {
    return __vitePreload(() => import('./dockerfile-BuGto-eh.js'),true              ?__vite__mapDeps([23,24]):void 0).then(m => legacy(m.dockerFile));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "DTD",
  extensions: ["dtd"],
  ...
  extensions: ["factor"],
  load() {
    return __vitePreload(() => import('./factor-P_9RAvyH.js'),true              ?__vite__mapDeps([25,24]):void 0).then(m => legacy(m.factor));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "FCL",
  load() {
  ...
  extensions: ["nsh", "nsi"],
  load() {
    return __vitePreload(() => import('./nsis-DIgWeoaq.js'),true              ?__vite__mapDeps([26,24]):void 0).then(m => legacy(m.nsis));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "NTriples",
  extensions: ["nt", "nq"],
  ...
  extensions: ["pug", "jade"],
  load() {
    return __vitePreload(() => import('./pug-DdQ9vxDY.js'),true              ?__vite__mapDeps([27,28]):void 0).then(m => legacy(m.pug));
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Puppet",
  extensions: ["pp"],
  ...
  extensions: ["vue"],
  load() {
    return __vitePreload(() => import('./index-BO4Xrq47.js'),true              ?__vite__mapDeps([29,1,2,8,3,6,9,4]):void 0).then(m => m.vue());
  }
}), /*@__PURE__*/LanguageDescription.of({
  name: "Angular Template",
  load() {
    return __vitePreload(() => import('./index-BveSpPBk.js'),true              ?__vite__mapDeps([30,1,2,8,3,6,9,4]):void 0).then(m => m.angular());
  }
})];
