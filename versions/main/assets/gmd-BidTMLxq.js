const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Ds6oaN3_.js","assets/main-CG8p5uIL.js","assets/main-BFTqJWQj.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CG8p5uIL.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Ds6oaN3_.js');return {
    parseMarkdown
