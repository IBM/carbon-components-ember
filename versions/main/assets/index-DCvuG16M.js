import { e as EditorView, h as EditorSelection, L as LanguageSupport, p as parseMixed, g as syntaxTree, a as LRLanguage, s as styleTags, t as tags, i as indentNodeProp, l as delimitedIndent, d as foldNodeProp, b as LRParser, E as ExternalTokenizer, j as LocalTokenGroup } from './index-DUpYiFjb.js';
import { b as html } from './index-DxA39neW.js';
...
function jinjaCompletionSource(config = {}) {
  ...
  return context => {
    ...
    let options;
    if (cx.type == "filter") options = Filters;else if (cx.type == "tag") options = tags;else if (cx.type == "expr") options = exprs;else /* prop */
