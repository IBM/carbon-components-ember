const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-sUnVj5zV.js","assets/main-7HJT-N6P.js","assets/main-DwCUJTZC.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-7HJT-N6P.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-sUnVj5zV.js');return {
    parseMarkdown
