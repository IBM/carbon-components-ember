const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-bS0f_2p6.js","assets/main-vBcrfInl.js","assets/main-DwCUJTZC.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-vBcrfInl.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-bS0f_2p6.js');return {
    parseMarkdown
