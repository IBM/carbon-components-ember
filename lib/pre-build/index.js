...
class PreBuild {
  ...
  runCommand(commandOptions, rawArgs) {
    ...
    const addonMain = new Funnel('.', {
      files: ['package.json', addonEntry, 'types', 'config/environment.js', 'index.d.ts', 'CHANGELOG.md', 'README.md', 'tsconfig.json'],
    ...
    return builder.build()
      ...
      .then(() => {
        ...
        fs.writeFileSync(`${outputDir}/package.json`, JSON.stringify(pkg));
