...
5. Runs agent with structured prompt
6. agent will:
...
- You can modify the prompt template to customize agent's behavior
...
- [.github/workflows/templates/agent-prompt.md](../.github/workflows/templates/agent-prompt.md) - Structured prompt template
