const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Df42pW2T.js","assets/main-Cy4y5_uE.js","assets/main-DKHu0Zdr.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-Cy4y5_uE.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Df42pW2T.js');return {
    parseMarkdown
