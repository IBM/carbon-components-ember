const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-aR3K_br6.js","assets/main-ARMEkVMa.js","assets/main-Dk32_x-H.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-ARMEkVMa.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-aR3K_br6.js');return {
    parseMarkdown
