import { k as resource, l as decorateFieldV2, m as initializeDeferredDecorator, w as waitForPromise, n as tracked, p as resourceFactory } from './main-Bc-yroTz.js';
...
class State {
   ...
   */
  static {
    decorateFieldV2(this.prototype, "status", [tracked], function () {
      return null;
    });
  }
  #status = (initializeDeferredDecorator(this, "status"), void 0);
  /**
   * HTTP status code.
   */
  static {
    decorateFieldV2(this.prototype, "isResolved", [tracked], function () {
      return false;
    });
  }
  #isResolved = (initializeDeferredDecorator(this, "isResolved"), void 0);
  /**
   * True if the request has succeeded
   */
  static {
    decorateFieldV2(this.prototype, "isRejected", [tracked], function () {
      return false;
    });
  }
  #isRejected = (initializeDeferredDecorator(this, "isRejected"), void 0);
  /**
