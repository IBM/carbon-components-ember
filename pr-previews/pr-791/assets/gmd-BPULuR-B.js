const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DOqQ0AlL.js","assets/main-vSawCcWa.js","assets/main-CptHFmK2.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-vSawCcWa.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DOqQ0AlL.js');return {
    parseMarkdown
