...
import { u as styleTags, v as tags, a as LanguageSupport, r as LRLanguage, O as indentNodeProp, ag as flatIndent, U as continuedIndent, X as delimitedIndent, K as foldNodeProp, Y as foldInside, s as syntaxTree, af as NodeWeakMap, I as IterMode } from './index-BZr71EI0.js';
...
let trackedTokens = new Set([IncDecOp, identifier, Rune, String, Number, _break, _continue, _return, fallthrough, closeParen$1, closeBracket, closeBrace$1]);
...
*/
const snippets = [/*@__PURE__*/snippetCompletion("func ${name}(${params}) ${type} {\n\t${}\n}", {
  label: "func",
  detail: "declaration",
  type: "keyword"
...
const ScopeNodes = /*@__PURE__*/new Set(["SourceFile", "Block", "FunctionDecl", "MethodDecl", "FunctionLiteral", "ForStatement", "SwitchStatement", "TypeSwitchStatement", "IfStatement"]);
...
const dontComplete = ["String", "LineComment", "BlockComment", "DefName", "LabelName", "FieldName", ".", "?."];
/**
