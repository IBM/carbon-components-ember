const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-y3IRb0pP.js","assets/main-Bzuz0_Jc.js","assets/main-7DX18_BU.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-Bzuz0_Jc.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-y3IRb0pP.js');return {
    parseMarkdown
