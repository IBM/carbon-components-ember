...
import { a as LanguageSupport, r as LRLanguage, O as indentNodeProp, K as foldNodeProp, b as EditorView, s as syntaxTree, E as EditorSelection, t as parseMixed, u as styleTags, v as tags } from './index-BZr71EI0.js';
import { css, cssLanguage } from './index-Da_U3wY2.js';
import { a as javascript, p as parser$1, t as typescriptLanguage, j as javascriptLanguage } from './index-dqVyFyRL.js';
import { htmlCompletionSource } from './index-CkCz5A90.js';
...
const parser = /*@__PURE__*/LRParser.deserialize({
  ...
  nodeProps: [["closedBy", -10, 1, 2, 3, 5, 6, 7, 8, 9, 10, 11, "EndTag", 4, "EndTag SelfClosingEndTag", 17, "IfBlockClose", 18, "}", 31, "EachBlockClose", 34, "(", 40, "AwaitBlockClose", 48, "AwaitBlockOpen", 50, "KeyBlockClose", -4, 68, 112, 115, 118, "CloseTag", 101, "\"", 103, "'"], ["group", -10, 12, 60, 64, 65, 66, 67, 126, 127, 128, 129, "Entity", -4, 16, 30, 39, 49, "Block Entity", -4, 17, 31, 40, 50, "BlockOpen", -3, 24, 44, 46, "BlockInline", -4, 28, 38, 48, 52, "BlockClose", -4, 53, 56, 58, 61, "BlockInline Entity", 63, "Entity TextContent", -3, 110, 113, 116, "TextContent Entity"], ["openedBy", 23, "{", 28, "IfBlockOpen", 35, ")", 38, "EachBlockOpen", 52, "KeyBlockOpen", 101, "\"", 103, "'", 109, "StartTag StartCloseTag", -4, 111, 114, 117, 123, "OpenTag", 125, "StartTag"]],
...
const expressionParser = /*@__PURE__*/parser$1.configure({
...
const svelteLanguage = /*@__PURE__*/LRLanguage.define({
  // @ts-expect-error
...
const autoCloseTags = /*@__PURE__*/EditorView.inputHandler.of((view, from, to, text) => {
  if (view.composing || view.state.readOnly || from != to || text != ">" && text != "/" || !svelteLanguage.isActiveAt(view.state, from, -1)) return false;
  let {
    state
  } = view;
...
export { svelte, svelteLanguage, parser as svelteParser };
