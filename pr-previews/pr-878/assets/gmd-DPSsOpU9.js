const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-NhAe2EmE.js","assets/main-f2pqWeg8.js","assets/main-Cegkd6fI.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-f2pqWeg8.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-NhAe2EmE.js');return {
    parseMarkdown
