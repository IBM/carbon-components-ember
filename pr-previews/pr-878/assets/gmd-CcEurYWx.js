const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-rU-GgNfT.js","assets/main-D6YvWpQT.js","assets/main-BRDg_8S7.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-D6YvWpQT.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-rU-GgNfT.js');return {
    parseMarkdown
