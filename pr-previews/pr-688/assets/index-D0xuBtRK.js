const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/plugin-CrUvUxCc.js","assets/_commonjsHelpers-BFTU3MAI.js","assets/babel-DhBN8P6V.js"])))=>i.map(i=>d[i]);
import { H as Helper, K as helper$1, L as htmlSafe, N as isHTMLSafe, P as isTrustedHTML, Q as trustHTML, R as compare, T as isBlank, F as isEmpty, G as isEqual, U as isNone, V as isPresent, W as typeOf, X as decorateClass, Y as decorateFieldV1, Z as decorateFieldV2, $ as initializeDeferredDecorator, a0 as decorateMethodV1, a1 as decorateMethodV2, a2 as decoratePOJO, a3 as _tracking, a4 as Component, a5 as _owner, i as templateFactory, a6 as _service, a7 as _runloop, a8 as _object, a9 as _modifier, aa as _helpers, ab as _destroyable, ac as _debug, ad as _EmberComponent, ae as _array, af as _application, t as templateOnly, ag as nameFor, ah as __vitePreload } from './main-CwDuIC-C.js';
		...
		(function (ember, emberGlimmer, templateCompilation, emberApp) {
		  ...
		  let deprecate$1 = () => {};
		  {
		    ...
		    */
		    deprecate$1 = function deprecate(message, test, options) {
		      assert$2(missingOptionsDeprecation$1, Boolean(options && (options.id || options.until)));
		      assert$2(missingOptionsIdDeprecation$1, Boolean(options.id));
		      assert$2(missingOptionDeprecation(options.id, 'until'), Boolean(options.until));
		      assert$2(missingOptionDeprecation(options.id, 'for'), Boolean(options.for));
		      assert$2(missingOptionDeprecation(options.id, 'since'), Boolean(options.since));
...

		  {
		    ...
		    */
		    warn$1 = function warn(message, test, options) {
		      ...
		      assert$2(missingOptionsDeprecation, Boolean(options));
		      assert$2(missingOptionsIdDeprecation, Boolean(options && options.id));
		  ...
		  */
		  ...
		  function inspectObject(obj, depth, seen) {
		    ...
		    for (let i = 0; i < keys.length; i++) {
		      ...
		      let key = keys[i];
		      assert$2('has key', key); // Looping over array
		    ...
		    if (typeof window !== 'undefined' && (isFirefox || isChrome) && window.addEventListener) {
		      window.addEventListener('load', () => {
		        if (document.documentElement && document.documentElement.dataset && !document.documentElement.dataset['emberExtension']) {
		          ...
		          debug$1(`For more advanced debugging, install the Ember Inspector from ${downloadURL}`);
		        }
		      }, false);
		    }
		  }
		  ...
		  }
		  {
		    ...
		    setupMandatorySetter = function (tag, obj, keyName) {
		      ...
		      Object.defineProperty(obj, keyName, {
		        ...
		        set(value) {
		          assert$2(`You attempted to update ${this}.${String(keyName)} to "${String(value)}", but it is being tracked by a tracking context, such as a template, computed property, or observer. In order to make sure the context updates properly, you must invalidate the property when updating it. You can mark the property as \`@tracked\`, or use \`@ember/object#set\` to do this.`);
		        }
		      });
		    };
		  ...
		  */
		  ...
		  function buildKeyword(normalized, symbols) {
		    ...
		    switch (name) {
		      case 'let':
		        return [opcodes.Let, expect(params), block];
		      case 'if':
		        return [opcodes.If, expect(params)[0], block, inverse];
		      case 'each':
		        {
		          let keyExpr = normalized.hash ? normalized.hash['key'] : null;
		          let key = keyExpr ? buildExpression(keyExpr, 'Strict', symbols) : null;
		          return [opcodes.Each, expect(params)[0], key, block, inverse];
		        }
		      default:
		        throw new Error('unimplemented keyword');
		    }
		  }
		  function buildElement$1({
		    name,
		    attrs,
		    block
		  }, symbols) {
		  ...
		  function buildExpression(expr, context, symbols) {
		    switch (expr.type) {
		      ...
		      case CONCAT_EXPR:
		        {
		          return [opcodes.Concat, buildConcat$1(expr.params, symbols)];
		        }
		      case CALL_EXPR:
		        {
		      ...
		      case HAS_BLOCK_EXPR:
		        {
		          return [opcodes.HasBlock, buildVar$1({
		            kind: BLOCK_VAR,
		            name: expr.name
		      ...
		      case HAS_BLOCK_PARAMS_EXPR:
		        {
		          return [opcodes.HasBlockParams, buildVar$1({
		            kind: BLOCK_VAR,
		            name: expr.name
		          }, resolution.Strict, symbols)];
		        }
		  ...
		  */
		  ...
		  class SourceSpan {
		    ...
		    toSlice(expected) {
		      ...
		      assert$1(expected === undefined || expected === chars, `unexpectedly found ${JSON.stringify(chars)} when slicing source, ` + `but expected ${JSON.stringify(expected)}`);
		      return new SourceSlice({
		        loc: this,
		  ...
		  const api$1 = /*#__PURE__*/Object.defineProperty({
		    __proto__: null,
		  ...
		  class Parser {
		    ...
		    sourceForNode(node, endNode) {
		      ...
		      while (currentLine < lastLine) {
		        currentLine++;
		        line = unwrap$1(this.lines[currentLine]);
		  ...
		  function calculateRightStrippedOffsets(original, value) {
		    ...
		    return {
		      lines: lineCount,
		      columns: unwrap$1(lines[lineCount]).length
		    };
		  }
		  ...
		  */
		  ...
		  class BlockSymbolTable extends SymbolTable {
		    ...
		    #get(name) {
		      ...
		      return slot === -1 ? null : unwrap$1(this.slots[slot]);
		    }
		    getLocalsMap() {
		  ...
		  createPrimitiveRef(undefined);
		  createPrimitiveRef(null);
		  createPrimitiveRef(true);
		  createPrimitiveRef(false);
		  ...
		  const defaultId = (() => {
		    ...
		    // @ts-expect-error using node API here, but only here
		    commonjsRequire : globalThis.require;
		    if (req) {
		      try {
		      ...
		      visitor: {
		        ...
		        PathExpression(node) {
		          if (isAttrs(node, hasLocal)) {
		            assert$2(`Using {{attrs}} to reference named arguments is not supported. {{${node.original}}} should be updated to {{@${node.original.slice(6)}}}. ${calculateLocationDisplay$1(moduleName, node.loc)}`);
		      ...
		      visitor: {
		        ...
		        MustacheStatement(node) {
		          if (node.path.type === 'PathExpression' && node.path.original === 'outlet' && node.params[0] && !hasLocal('outlet')) {
		            ...
		            assert$2(`Named outlets were removed in Ember 4.0. See https://deprecations.emberjs.com/v3.x#toc_route-render-template for guidance on alternative APIs for named outlet use cases. ${sourceInformation}`);
		          }
		        }
		      }
		    };
		      ...
		      visitor: {
		        ...
		        BlockStatement(node) {
		          ...
		          if (isPath(node.path) && node.path.original === 'input') {
		            assert$2(assertMessage$1(moduleName, node));
		          }
		        }
		      }
		    };
		    ...
		    return {
		      ...
		      visitor: {
		        ...
		        AttrNode({
		          ...
		          if (name === '@__ARGS__') {
		            assert$2(`${assertMessage(name)} ${calculateLocationDisplay$1(moduleName, loc)}`);
		          }
		        },
		        HashPair({
		          key,
		          ...
		          if (key === '__ARGS__') {
		            assert$2(`${assertMessage(key)} ${calculateLocationDisplay$1(moduleName, loc)}`);
		          }
		        },
		        PathExpression({
		          original,
		          ...
		          if (isReserved(original)) {
		            assert$2(`${assertMessage(original)} ${calculateLocationDisplay$1(moduleName, loc)}`);
		          }
		        }
		      }
		    };
		      ...
		      visitor: {
		        ...
		        BlockStatement(node) {
		          if (isPath(node.path) && node.path.original === 'each' && !hasLocal('each')) {
		            ...
		            !firstParam && assert$2('has firstParam', firstParam);
		          ...
		          if (node.path.original === 'in-element') {
		            ...
		            node.hash.pairs.forEach(pair => {
		              if (pair.key === 'insertBefore') {
		                !(pair.value.type === 'NullLiteral' || pair.value.type === 'UndefinedLiteral') && assert$2(`Can only pass null to insertBefore in in-element, received: ${JSON.stringify(pair.value)}`, pair.value.type === 'NullLiteral' || pair.value.type === 'UndefinedLiteral');
		              }
		            });
		          }
		        }
		  ...
		  */
		  ...
		  function transformResolutions(env) {
		    ...
		    return {
		      ...
		      visitor: {
		        ...
		        MustacheStatement(node) {
		          !seen && assert$2('[BUG] seen set should be available', seen);
		          if (seen.has(node)) {
		            return;
		          }
		  ...
		  function transformParams(b, params, type, moduleName, loc) {
		    ...
		    !first && assert$2(`The ${type} keyword requires at least one positional arguments ${calculateLocationDisplay$1(moduleName, loc)}`, first);
		  ...
		  */
		  ...
		  function buildCompileOptions(_options) {
		    ...
		    let options = Object.assign({
		      ...
		      customizeComponentName(tagname) {
		        !!malformedComponentLookup(tagname) && assert$2(`You tried to invoke a component named <${tagname} /> in "${moduleName ?? '[NO MODULE]'}", but that is not a valid name for a component. Did you mean to use the "::" syntax for nested components?`, !malformedComponentLookup(tagname));
		    ...
		    if (options.moduleName) {
		      ...
		      !meta && assert$2('has meta', meta); // We just set it
		  ...
		  function compileOptions(_options = {}) {
		    ...
		    if (!_options.plugins) {
		      ...
		      !options.plugins && assert$2('expected plugins', options.plugins);
...
async function preprocess(input, name) {
  if (!fetchingPromise) {
    fetchingPromise = __vitePreload(() => import('./standalone-uPmQJOj-.js'),true              ?[]:void 0);
  }
  if (!processor) {
    const {
      Preprocessor
...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-C6I8bxcL.js'),true              ?[]:void 0), __vitePreload(() => import('./plugin-CrUvUxCc.js').then(n => n.p),true              ?__vite__mapDeps([0,1]):void 0)]);
  ...
  const maybeBabel = await __vitePreload(() => import('./babel-DhBN8P6V.js').then(n => n.b),true              ?__vite__mapDeps([2,1]):void 0);
