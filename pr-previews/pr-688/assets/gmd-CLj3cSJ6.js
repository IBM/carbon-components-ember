const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Byd4hnbY.js","assets/main-C2KSrfgt.js","assets/main-DmbUwLJh.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { Z as buildCodeFenceMetaUtils, W as __vitePreload, Y as isRecord, $ as assert } from './main-C2KSrfgt.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Byd4hnbY.js');return {
    parseMarkdown
