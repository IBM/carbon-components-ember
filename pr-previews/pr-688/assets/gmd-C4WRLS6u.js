const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-B_GkLdsO.js","assets/main-ChsN7yJb.js","assets/main-DmbUwLJh.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { Y as buildCodeFenceMetaUtils, Z as __vitePreload, X as isRecord, $ as assert } from './main-ChsN7yJb.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-B_GkLdsO.js');return {
    parseMarkdown
