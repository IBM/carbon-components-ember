const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-LIM5JPlI.js","assets/main-mYDF5YNL.js","assets/main-vkVTAYTq.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-mYDF5YNL.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-LIM5JPlI.js');return {
    parseMarkdown
