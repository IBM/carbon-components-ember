const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Dd2Rcm2s.js","assets/main-CIYrVr9L.js","assets/main-eT2NH7VN.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CIYrVr9L.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Dd2Rcm2s.js');return {
    parseMarkdown
