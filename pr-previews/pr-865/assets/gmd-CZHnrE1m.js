const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-CxUDPlaH.js","assets/main-MxPzQ-Rr.js","assets/main-vkVTAYTq.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-MxPzQ-Rr.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-CxUDPlaH.js');return {
    parseMarkdown
