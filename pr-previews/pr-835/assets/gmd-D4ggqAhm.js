const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-_ZyyIQzK.js","assets/main-D448UZ0K.js","assets/main-CFbrRHer.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-D448UZ0K.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-_ZyyIQzK.js');return {
    parseMarkdown
