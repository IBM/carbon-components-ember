const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-zHLkJYNK.js","assets/main-06uClyRI.js","assets/main-CFbrRHer.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-06uClyRI.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-zHLkJYNK.js');return {
    parseMarkdown
