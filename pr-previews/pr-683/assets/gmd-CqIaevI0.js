const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-CO25IydD.js","assets/main-CQBN_VgS.js","assets/main-CDAc8LpV.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CQBN_VgS.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-CO25IydD.js');return {
    parseMarkdown
