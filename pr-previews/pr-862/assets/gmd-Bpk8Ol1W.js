const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-CvNQuuP2.js","assets/main-Bgm_fn2U.js","assets/main-DFXZK6qt.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-Bgm_fn2U.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-CvNQuuP2.js');return {
    parseMarkdown
