const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-5zmfpqUU.js","assets/main-CfGJEi9V.js","assets/main-DFXZK6qt.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CfGJEi9V.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-5zmfpqUU.js');return {
    parseMarkdown
