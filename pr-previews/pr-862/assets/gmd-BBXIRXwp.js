const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DOIoN3Xj.js","assets/main-rpgOYvkN.js","assets/main-DzZUxUER.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-rpgOYvkN.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DOIoN3Xj.js');return {
    parseMarkdown
