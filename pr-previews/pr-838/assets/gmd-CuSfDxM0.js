const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-7fKEQpCB.js","assets/main-CJcmd6qW.js","assets/main-DjXJk6mQ.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CJcmd6qW.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-7fKEQpCB.js');return {
    parseMarkdown
