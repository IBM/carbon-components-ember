const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-cmLq80E7.js","assets/main-Cx3ruBCz.js","assets/main-DzVV-D8k.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-Cx3ruBCz.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-cmLq80E7.js');return {
    parseMarkdown
