import { P as Parser, N as NodeType, n as NodeProp, T as Tag, o as NodeSet, s as styleTags, q as Tree, t as tags, p as parseMixed, g as syntaxTree, h as EditorSelection, r as countColumn, u as Prec, v as keymap, L as LanguageSupport, w as indentUnit, f as foldService, x as Language, y as defineLanguageFacet, z as EditorState, e as EditorView, d as foldNodeProp, i as indentNodeProp, A as languageDataProp, c as LanguageDescription, B as ParseContext } from './index-Do7mdVNL.js';
import { C as CompletionContext } from './index-B39lEP9I.js';
import { b as html, h as htmlCompletionSource } from './index-DIczsbTV.js';
...
class InlineContext {
  ...
  */
  findOpeningDelimiter(type) {
    for (let i = this.parts.length - 1; i >= 0; i--) {
      let part = this.parts[i];
      if (part instanceof InlineDelimiter && part.type == type && part.side & 1 /* Mark.Open */) return i;
    }
    return null;
  }
  /**
  ...
  nextLine(cx, line, leaf) {
    if (this.rows == null) {
      ...
      if ((line.next == 45 || line.next == 58 || line.next == 124 /* '-:|' */) && delimiterLine.test(lineText = line.text.slice(line.pos))) {
        ...
        if (firstCount == parseRow(cx, lineText, 0)) this.rows = [cx.elt("TableHeader", leaf.start, leaf.start + leaf.content.length, firstRow), cx.elt("TableDelimiter", cx.lineStart + line.pos, cx.lineStart + line.text.length)];
      }
    } else if (this.rows) {
...
*/
const insertNewlineContinueMarkupCommand = (config = {}) => ({
  state,
  dispatch
}) => {
...
export { Emoji as E, GFM as G, Subscript as S, Table as T, Superscript as a, markdownKeymap as b, index as i, markdown as m, parser as p };
