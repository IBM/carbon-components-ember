const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-BTJ_VbPe.js","assets/main-CcY9fuIv.js","assets/main-C-C_dhTh.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CcY9fuIv.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-BTJ_VbPe.js');return {
    parseMarkdown
