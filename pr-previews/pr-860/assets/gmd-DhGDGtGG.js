const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-CO4y2Wfs.js","assets/main-B0tDUzg_.js","assets/main-C-C_dhTh.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-B0tDUzg_.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-CO4y2Wfs.js');return {
    parseMarkdown
