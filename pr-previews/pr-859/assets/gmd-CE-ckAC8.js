const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DFJsIv8w.js","assets/main-B8uzkW5d.js","assets/main-wcbsPCdB.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-B8uzkW5d.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DFJsIv8w.js');return {
    parseMarkdown
