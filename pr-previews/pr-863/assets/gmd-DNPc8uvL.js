const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-C9C9H4o2.js","assets/main-DDZRDZup.js","assets/main-DwCUJTZC.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-DDZRDZup.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-C9C9H4o2.js');return {
    parseMarkdown
