const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DsJjJJfB.js","assets/main-CRPpRmQ3.js","assets/main-BiZCfKvT.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-CRPpRmQ3.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DsJjJJfB.js');return {
    parseMarkdown
