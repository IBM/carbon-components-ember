const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DCQhHdS2.js","assets/main-vqCLVV2v.js","assets/main-BiZCfKvT.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-vqCLVV2v.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DCQhHdS2.js');return {
    parseMarkdown
