const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-DlGSVIlC.js","assets/main-H6jDK-6D.js","assets/main-DrNVj66Q.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-H6jDK-6D.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-DlGSVIlC.js');return {
    parseMarkdown
