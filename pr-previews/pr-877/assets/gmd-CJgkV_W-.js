const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-cd8-2bCa.js","assets/main-hmVj-5AR.js","assets/main-BmeoXkyn.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-hmVj-5AR.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-cd8-2bCa.js');return {
    parseMarkdown
