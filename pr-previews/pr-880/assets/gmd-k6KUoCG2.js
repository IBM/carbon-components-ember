const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-nZ-fjipy.js","assets/main-BsFsyvFu.js","assets/main-Dk32_x-H.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-BsFsyvFu.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-nZ-fjipy.js');return {
    parseMarkdown
