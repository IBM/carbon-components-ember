const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-B1WdF1-r.js","assets/main-BR8ibdeW.js","assets/main-Dk32_x-H.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-BR8ibdeW.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-B1WdF1-r.js');return {
    parseMarkdown
