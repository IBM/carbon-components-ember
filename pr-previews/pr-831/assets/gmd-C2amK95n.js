const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-K3Co8g5B.js","assets/main-C9M3wvzN.js","assets/main-CFbrRHer.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-C9M3wvzN.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-K3Co8g5B.js');return {
    parseMarkdown
