const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-4MBAqmLc.js","assets/main-DZin9OFc.js","assets/main-DVGDB7Cm.css","assets/_commonjsHelpers-B85MJLTf.js"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-DZin9OFc.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-4MBAqmLc.js');return {
    parseMarkdown
