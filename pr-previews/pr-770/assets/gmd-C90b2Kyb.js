const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Bqk8e4cE.js","assets/main-D0_NGsmE.js","assets/main-DVGDB7Cm.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-D0_NGsmE.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Bqk8e4cE.js');return {
    parseMarkdown
