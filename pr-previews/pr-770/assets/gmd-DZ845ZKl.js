const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Bx7-e53h.js","assets/main-D5h3ux0H.js","assets/main-CZqUSikt.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-D5h3ux0H.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Bx7-e53h.js');return {
    parseMarkdown
