const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-D9j4CoxR.js","assets/main-BYDjTx4L.js","assets/main-DVGDB7Cm.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-BYDjTx4L.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-D9j4CoxR.js');return {
    parseMarkdown
