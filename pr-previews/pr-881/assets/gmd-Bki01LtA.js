const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-CdOc3sMK.js","assets/main-ruMWrtGY.js","assets/main-Bs6hwKt5.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-ruMWrtGY.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-CdOc3sMK.js');return {
    parseMarkdown
