const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-BgqNUtq2.js","assets/main-4uZWg06Y.js","assets/main-Dk32_x-H.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-4uZWg06Y.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-BgqNUtq2.js');return {
    parseMarkdown
