const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/parse-Bh0dFUlC.js","assets/main-DBBdV0JL.js","assets/main-NBtOBZa1.css"])))=>i.map(i=>d[i]);
import { V as buildCodeFenceMetaUtils, R as __vitePreload, U as isRecord, W as assert } from './main-DBBdV0JL.js';
...
async function compiler(config, api) {
  ...
  const {
    ...
    parseMarkdown
  } = await import('./parse-Bh0dFUlC.js');return {
    parseMarkdown
